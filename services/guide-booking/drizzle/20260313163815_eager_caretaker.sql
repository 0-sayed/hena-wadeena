...
CREATE INDEX "idx_tour_packages_created_at" ON "guide_booking"."tour_packages" USING btree ("created_at" DESC NULLS LAST);--> statement-breakpoint
-- Trigger function: recalculate guides.rating_avg and rating_count from guide_reviews
...
CREATE TRIGGER trg_guide_reviews_rating
  AFTER INSERT OR UPDATE OR DELETE ON "guide_booking"."guide_reviews"
  FOR EACH ROW
