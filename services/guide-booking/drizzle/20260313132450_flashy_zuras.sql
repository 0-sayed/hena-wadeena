...
ALTER TABLE "guide_booking"."guide_reviews" ADD CONSTRAINT "guide_reviews_booking_id_bookings_id_fk" FOREIGN KEY ("booking_id") REFERENCES "guide_booking"."bookings"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "guide_booking"."guide_reviews" ADD CONSTRAINT "guide_reviews_guide_id_guides_id_fk" FOREIGN KEY ("guide_id") REFERENCES "guide_booking"."guides"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
