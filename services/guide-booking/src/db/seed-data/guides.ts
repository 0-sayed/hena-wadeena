...
export const essentialGuides: SeedGuide[] = [
  {
    ...
    languages: ['ar', 'en'],
    specialties: ['archaeology', 'history', 'temples'],
...
export const showcaseGuides: SeedGuide[] = [
  {
    ...
    languages: ['ar', 'en', 'fr'],
    specialties: ['desert', 'camping', 'safari'],
  ...
  },
  {
    ...
    languages: ['ar', 'en'],
    specialties: ['adventure', 'camping', 'sandboarding'],
  ...
  },
  {
    ...
    languages: ['ar'],
    specialties: ['wellness', 'hot_springs', 'medical_tourism'],
  ...
  },
  {
    ...
    languages: ['ar', 'en', 'de'],
    specialties: ['photography', 'landscapes', 'architecture'],
