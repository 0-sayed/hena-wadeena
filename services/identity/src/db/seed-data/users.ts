...
export const essentialUsers: SeedUser[] = [
  ...
  {
    id: USER.JUDGE_DR_HATBA,
    email: 'dr.hatba@hena-wadeena.online',
    phone: null,
    fullName: 'د.م. محمد حطبه',
    displayName: 'د.م. محمد حطبه',
    avatarUrl: avatar('dr.hatba@hena-wadeena.online'),
    role: 'admin',
    status: 'active',
    language: 'ar',
    verifiedAt: now,
  ...
  {
    id: USER.JUDGE_DR_ROMANI,
    email: 'dr.romani@hena-wadeena.online',
    phone: null,
    fullName: 'د.م. روماني فؤاد',
    displayName: 'د.م. روماني فؤاد',
    avatarUrl: avatar('dr.romani@hena-wadeena.online'),
    role: 'admin',
    status: 'active',
    language: 'ar',
    verifiedAt: now,
  ...
  {
    id: USER.JUDGE_DR_HOSSAM,
    email: 'dr.hossam@hena-wadeena.online',
    phone: null,
    fullName: 'د.م. حسام علي',
    displayName: 'د.م. حسام علي',
    avatarUrl: avatar('dr.hossam@hena-wadeena.online'),
    role: 'admin',
    status: 'active',
    language: 'ar',
    verifiedAt: now,
