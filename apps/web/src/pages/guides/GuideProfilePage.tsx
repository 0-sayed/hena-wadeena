...
const GuideProfilePage = () => {
  ...
  const guideName = guide ? getGuideName(publicUsers.data?.[guide.userId], t('guide.defaultName')) : t('guide.defaultName');
                      ...
                      <CardContent className="p-5 space-y-3">
                        ...
                        {review.guideReply && (
                          <div className="ms-4 border-s-2 border-primary/30 ps-4">
                            <p className="text-xs font-semibold text-primary mb-1">{t('reviews.guideReply')}</p>
