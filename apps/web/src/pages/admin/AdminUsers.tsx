...
const statusKeys = ['active', 'suspended', 'banned'] as const;
  ...
  if (error) {
    return (
      <div className="flex flex-col items-center justify-center gap-4 py-12">
        ...
        <p className="text-lg text-muted-foreground">{t('users.loadError')}</p>
      </div>
    );
  }

  const usersDescription = !data ? t('users.loading') : t('users.count', { count: data.total });
