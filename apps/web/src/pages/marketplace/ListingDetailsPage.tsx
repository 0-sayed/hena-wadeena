                ...
                <CardContent className="p-6">
                  <div className="mb-4 flex flex-wrap items-center gap-2">
                    <Badge variant="secondary">
                      {listingCategoryLabel(listing.category, language === 'en' ? 'en' : 'ar')}
                    </Badge>
                    <Badge variant="outline">
                      {transactionLabel(listing.transaction, language === 'en' ? 'en' : 'ar')}
                    </Badge>
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span>
                        {districtLabel(
                          listing.district ??
                            listing.address ??
                            t('listingDetails.undefinedDistrict'),
                          language === 'en' ? 'en' : 'ar',
                        )}
                      </span>
                    </div>
                ...
                <CardContent className="space-y-4">
                  <div className="rounded-lg bg-primary/5 py-4 text-center">
                    <p className="text-sm text-muted-foreground">
                      {t('listingDetails.priceLabel')}
                    </p>
                    <p className="text-3xl font-bold text-primary">{formatPrice(listing.price)}</p>
                    <p className="text-sm text-muted-foreground">
                      {t('listingDetails.priceUnit', {
                        unit: listing.priceUnit || t('listingDetails.unitFallback'),
                      })}
                    </p>
                  </div>
