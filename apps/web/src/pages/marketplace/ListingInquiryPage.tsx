    ...
    return (
      <Layout title={t('listingInquiry.title')}>
        <div className="container space-y-4 px-4 py-20 text-center">
          ...
          <Button onClick={() => void navigate('/marketplace')}>{t('listingInquiry.backToMarket')}</Button>
        </div>
      </Layout>
    );
  }
          ...
          <Card className="border-border/50">
            <CardHeader className="pb-2 text-center">
              ...
              <p className="text-muted-foreground">
                {owner
                  ? t('listingInquiry.cardDescription', { title: listing.titleAr, owner: owner.full_name })
            ...
            <CardContent className="pt-6">
              ...
              >
                ...
                <Button type="submit" className="w-full" size="lg" disabled={submitting || isOwner}>
                  ...
                  {submitting ? t('listingInquiry.button.submitting') : t('listingInquiry.button.submit')}
                </Button>
              </form>
            </CardContent>
          </Card>
