...
import { JOB_CATEGORY_OPTIONS, COMPENSATION_TYPE_OPTIONS, DISTRICTS, jobCategoryLabel, compensationTypeLabel, districtLabel } from '@/lib/format';
          ...
          <form onSubmit={(e) => void handleSubmit(e)} className="space-y-6">
            <Card className="border-border/50">
              ...
              <CardContent className="space-y-4">
                ...
                <div className="grid gap-4 md:grid-cols-2">
                  <div className="space-y-2">
                    <Label htmlFor="compensation">{t('compensationLabel', { currency: appLanguage === 'en' ? 'EGP' : 'جنيه' })}</Label>
                    <Input
                      id="compensation"
                      type="number"
                      min="0"
