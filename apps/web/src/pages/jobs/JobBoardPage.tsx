...
function JobCard({ job, onClick, language, t }: { job: JobPost; onClick: () => void; language: string; t: TFunction }) {
        ...
        <div className="container px-4">
          ...
          {isLoading ? (
            ...
            <div className="py-20 text-center space-y-4">
              ...
              {canPost && <Button onClick={() => void navigate('/jobs/post')}>{t('createJobBtn')}</Button>}
            </div>
          ) : (
            <>
              <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
